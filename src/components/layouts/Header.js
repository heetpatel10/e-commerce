            ...
            <div className="basis-1/5">
              <div className="flex items-center justify-end gap-4">
                ...
                <div className="flex relative">
                  ...
                  <div className="absolute -top-1 -right-2 flex items-center justify-center w-[20px] h-[20px] bg-secondarycolor text-white text-center rounded-full text-xs">
                    10
                  </div>
                </div>
              </div>
        ...
        <div className="bg-lightgraytheme px-24 border-black border-b-[0.5px]">
          <div className="flex w-full gap-8 justify-start items-center py-2">
            <div className="flex py-1 group items-center gap-1 font-medium relative hover-effect">
              ...
              <span className="text-xl group-hover:rotate-180 transition-all duration-300">
